...
<table role='presentation' width='600' cellspacing='0' cellpadding='0'
    ...
    public static string GenerateDriverCancellationEmail(
        string customerName,
        string bookingReferenceId, 
        string vehicleModel,
        string pickupDate,
...
<head>
    <meta charset='UTF-8'>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
    <title>Driver Cancellation</title>
</head>
...
<table role='presentation' width='600' cellspacing='0' cellpadding='0'
    ...
    <!-- Header -->
    <tr>
        <td style='background:linear-gradient(135deg,#f59e0b,#d97706); padding:25px; text-align:center;'>
            <h1 style='margin:0; color:#ffffff; font-size:22px;'>
                Driver Update
            </h1>
        </td>
    ...
    <tr>
        <td style='padding:30px; color:#333333;'>
            ...
            <p style='font-size:15px; line-height:1.6; margin:0 0 20px 0;'>
                We are writing to inform you that the driver assigned to your upcoming booking has unfortunately had to cancel their assignment.
            </p>

            <div style='background:#fffbeb; border-left:4px solid #f59e0b; padding:15px; border-radius:6px; margin-bottom:25px;'>
                <strong>Your Booking is Still Active</strong><br/>
                Your vehicle reservation remains confirmed. You can manage your booking and request a new driver through your dashboard.
            </div>

            <!-- Booking Reference -->
            <div style='text-align:center; margin:30px 0;'>
                <div style='display:inline-block; padding:15px 25px; font-size:22px; font-weight:bold; color:#d97706; background:#fef3c7; border:2px dashed #d97706; border-radius:8px;'>
                    Ref: {bookingReferenceId}
                </div>
            </div>
            ...
            <!-- Button -->
            <div style='text-align:center; margin:35px 0;'>
                <a href='{bookingsUrl}' style='background:#d97706; color:#ffffff; text-decoration:none; padding:14px 34px; border-radius:8px; font-size:16px; font-weight:bold; display:inline-block;'>
                    Manage Booking
                </a>
            </div>
